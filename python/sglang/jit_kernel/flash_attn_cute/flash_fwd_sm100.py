...
import sglang.jit_kernel.flash_attn_cute.pipeline as pipeline_custom
from sglang.jit_kernel.flash_attn_cute import blackwell_helpers as sm100_utils
from sglang.jit_kernel.flash_attn_cute import mma_sm100_desc as sm100_desc
from sglang.jit_kernel.flash_attn_cute import utils
from sglang.jit_kernel.flash_attn_cute.block_info import BlockInfo
from sglang.jit_kernel.flash_attn_cute.block_sparse_utils import (
    get_total_block_count,
    handle_block_sparse_empty_tile_correction_sm100,
    produce_block_sparse_loads_sm100,
    softmax_block_sparse_sm100,
)
from sglang.jit_kernel.flash_attn_cute.block_sparsity import BlockSparseTensors
from sglang.jit_kernel.flash_attn_cute.cute_dsl_utils import assume_tensor_aligned
...
from sglang.jit_kernel.flash_attn_cute.named_barrier import NamedBarrierFwdSm100
from sglang.jit_kernel.flash_attn_cute.pack_gqa import PackGQA, pack_gqa_layout
from sglang.jit_kernel.flash_attn_cute.paged_kv import PagedKVManager
from sglang.jit_kernel.flash_attn_cute.seqlen_info import SeqlenInfoQK
from sglang.jit_kernel.flash_attn_cute.softmax import (
    SoftmaxSm100,
    ...
    def softmax_loop(
        ...
        while work_tile.is_valid_tile:
            ...
            rescale_threshold = (
                ...
                else 4.0 if const_expr(self.q_dtype.width == 8) else 0.0
            )
