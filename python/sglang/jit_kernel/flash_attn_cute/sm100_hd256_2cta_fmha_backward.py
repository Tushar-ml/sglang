...
from sglang.jit_kernel.flash_attn_cute.sm100_hd256_2cta_fmha_backward_dkdvkernel import (
    BlackwellFusedMultiHeadAttentionBackwardDKDVKernel,
)
from sglang.jit_kernel.flash_attn_cute.sm100_hd256_2cta_fmha_backward_dqkernel import (
...
class BlackwellFusedMultiHeadAttentionBackward:
    ...
    def __call__(
        ...
        assert (
            dQ_semaphore is None and dK_semaphore is None and dV_semaphore is None
        ...
        assert (
            aux_tensors is None or len(aux_tensors) == 0
        ), "SM100 backward with head_dim=256 does not support aux_tensors"
        assert (
